...
| Feature | Coinbase `coinbase/x402` | This repo (`tzapac-x402-permit2`, Etherlink Beta) | Notes |
|---|---:|---:|---|
...
| Store pays gas mode (store submits on-chain txs) | ✗ | ✗ | Removed from the Beta frontend; not part of Coinbase model. |
...
| Sponsored ERC20 approval extension (`erc20ApprovalGasSponsoring`) | ✗ | ✗ | Documented in Coinbase specs; not implemented end-to-end in this Beta. |
...
| Multi-language SDKs (Go/TS/Python/Java) | ✓ | ✗ | This repo is a focused Beta + Rust facilitator fork, not a full SDK suite. |
